...
<link href="./static/css/danchang.css" rel="stylesheet">
	<div id="body" class="danchang_jinq">
        <header class="head headfixed">
            ...
            <div class="headertit topcenter column" @click="betChange">
                <a class="boxflex flexcenter tabbtn"><span class="fontwhite font16">单场总进球</span><em
            ...
            <div class="layerbox layerbox_header" v-show="isbetChange">
                ...
                <li class="boxflex">
                    ...
                    <p class="qibtn qibtn_sed">{{danchangTypeUrl[3].name}}</p>
                    </router-link>
                </li>
                </ul>
            </div>
            ...
            <div class="scrollbox">
                ...
                <div class="padmainbtm">
                    ...
                    <div v-for="(item,index) in oddsData" :key="index">
                        ...
                        <!-- matchtit over -->
                        <div class="matchlist matchlist_jinqiu" v-show='!item.show'>
                            <div class="border_b flexbox matchitem" v-for="(ite,ind) in item.list" :key="ind" v-if="ite.timetxt !== ''">
            ...
            <div class="jincaibtmcon">
                ...
                <div class="guoguan_list_wrap">
                    ...
                    <ul class="clearfix" >
                        ...
                        <li class="betbtn" v-for="(item,key) in  betlistArr.length" :key="key"
                        v-if="item>1 && item<=6" @click="togglePassType(item,1)"
                        v-bind:class="{'betbtn_sed':checkPassType(item,1)}">{{item}}串1</li>
                    </ul>
                    <p class="mb6 gray8b font12" v-if="field>=3 && field<=6">更多过关</p>
                    <ul class="clearfix">
...
export default {
	...
	methods:{
        ...
        //加载数据
		fetchData(){
            this.axios.post('/api/ball/GetBall/odds?code=oddsdanchangZjq').then(res => {
