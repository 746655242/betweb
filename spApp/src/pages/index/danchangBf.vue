                                        ...
                                        <tr>
                                            <div class="add-more-layer line">
                                                <div class="com comleft">
                                                    ...
                                                    <div class="table">
                                                        <div  v-for="(item2,index2) in optionConfig[2].cn" :key="index2" class="betBtn w5" 
                                                            v-bind:class="{'beton':betlist[ind]&&betlist[ind][optionConfig[2].mix[index2]]}"
                                                            @click="addbet(ite, optionConfig[2].mix[index2])"
                                                        >
                                                            <span class="zhu">{{item2}}</span><br>
                                                            <span class="chi">{{ite['OddsList'][optionConfig[2].mix[index2]]}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
