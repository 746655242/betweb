...
export default {
    ...
    methods: {
		...
		fetchData(){  //我的申请-->类型+专长
			...
			if(id){
				this.base.getData(this,this.host+'/api/ApplyPfUserForEditInitialById',{PfUserApplyId:id},function(data){	
					...
					me.PicId=Data.PfUserPicId
					me.file=Data.DownloadImgInfo.DownloadUrl
			...
			if(this.isValid){
				...
				this.base.getData(this,this.host+'/api/ApplyPfUserForEditById',params,function(data){
					if(data.ErrCode=='00000000'){
						...
						if(me.HavePicture==1){me.upPicId()}
					}
		...
		upPicId(){
			let me=this
			this.base.getData(this,this.host+'/api/ApplyPfUserForEditUpdImg',{PfUserApplyId:this.PfUserApplyId},function(data){
				console.log(111,data)
				me.PicId=data.ActionCode.EditApplyPfUserPicId
				me.submitPic()
			})
		},
		/* 上传图片 */
