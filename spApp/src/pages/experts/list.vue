<template>
    <div class="mineWrap" v-title data-title="专家列表">
				...
				<li class="expertsInfo" v-for="(item,index) in expertslist" :key="index">
					...
					<div class="expertsInfo-right">
						...
						<div class="articleAndInformation">
							...
							<router-link :to="$pagecode(item.PfUserDetialUrlLink,{PfUserCode:item.PfUserCode,PfUserId:item.PfUserId,PfUserGameTypeCode:item.PfUserGameTypeCode,PfUserPic:item.PfUserPic.UrlLink})" class="expertsInformation">专家详情</router-link>
						</div>
					</div>
				</li>
...
.mineWrap{
	.expertsList{
		...
		.expertsListBox::-webkit-scrollbar{
			display: none;
		}
	}
